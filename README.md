...
The MNIST database of handwritten digits (available in the following link \url{http://yann.lecun.com/exdb/mnist/}) is a subset of a larger set available from MNIST. It contains 70000 images. We introduce our proposed algorithm \ref{contour_extract} where we call $bwboundaries$ function implemented in Matlab in order to extract external contours from this image dataset.
